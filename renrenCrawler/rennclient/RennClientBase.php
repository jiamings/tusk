...
class RennClientBase {
	...
	public function getAuthorizeURL($redirectUri, $responseType = 'code', $state = null, $display = null, $forcelogin = null) {
		...
		$params ['scope'] = 'read_user_blog,read_user_message,read_user_notification,read_user_share';
	 ...
	 * @return array
	 */
	function getTokenFromTokenEndpoint($grantType, $keys, $tokenType = TokenType::MAC) {
		$params = array ();
		$params ['client_id'] = $this->clientId;
